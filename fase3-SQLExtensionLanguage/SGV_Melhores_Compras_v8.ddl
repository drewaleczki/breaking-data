...
COMMENT ON COLUMN mc_video_class.cd_class IS
    'Essa coluna armazena o código de Classificação do vídeo.';

COMMENT ON COLUMN mc_video_class.ds_class IS
    'Essa coluna armazena a classificação do vídeo, podendo ser Vídeo de instalação do produto; Uso no cotidiano; Comercial com personalidade; entre outros. '
    ;
