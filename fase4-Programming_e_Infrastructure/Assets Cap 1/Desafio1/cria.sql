...
--
-- Caso queira consultar o resultado.
--
...
INSERT INTO MC_ESTADO(SG_ESTADO, NM_ESTADO) VALUES ('RO', 'RONDONIA');  
...
INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, NR_INDICE_SATISFACAO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 5, 15, 7, 7,'Cliente nao consegue ativar o mouse', sysdate-8, 10, 'D', 'E');
...
INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, NR_INDICE_SATISFACAO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 3, 15, 2, 3,'Mouse não funciona corretamente!', sysdate-7, 12, 'D', 'E');
...
INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, NR_INDICE_SATISFACAO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 3, 7, 1, 5, 'Foi enviado apenas um pé da meia', sysdate-5, 8, 'D', 'E');
...
INSERT INTO MC_SGV_SAC(NR_SAC, NR_CLIENTE, CD_PRODUTO, CD_FUNCIONARIO, NR_INDICE_SATISFACAO, DS_DETALHADA_SAC,
DT_ABERTURA_SAC, HR_ABERTURA_SAC, TP_SAC, ST_SAC)
VALUES (SQ_MC_SGV_SAC.NEXTVAL, 6, 3, 2, 6,'O jogo imagem e ação veio faltando peças', sysdate-3, 12, 'D', 'E');
...
begin
	if p_nr_indice between 0 and 6 then
		...
		p_ds_indice := 'Índice satisfação inválido';
	end if;
end;
/

CREATE TABLE t_mc_aliquota_media_icms_estado (
    sg_estado VARCHAR2(2) PRIMARY KEY,  -- Código do estado (UF)
    vl_perc_aliquota_media NUMBER        -- Alíquota média do ICMS
);
